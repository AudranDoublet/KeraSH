function matrix_namer()
{
    ...
    echo "${genotype_name}_${epoch_nb}_${layer_id}_${sample_id}_${mat_type}.mat"
}
...
function mse()
{
    ...
    matrix_mul_self_p2p < "${MAT}/${temp2_name}" > "${MAT}/${temp1_name}"
    matrix_mul_scalar $(( 1 / batch_size )) < "${MAT}/${temp2_name}" > "${MAT}/output_name"
}
